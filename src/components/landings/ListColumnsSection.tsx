...
const ListColumnsSection: FC<Props> = ({
    ...
    return (
        <section className="w-full max-w-7xl mx-auto bg-white py-16 px-6 md:py-24 flex flex-col items-center">
            {/* Title */}
            {title && (
            ...
            {/* Lista */}
            <div className="flex flex-col md:flex-row gap-12 md:gap-16 mb-20 w-full justify-center text-left">
                {list.map((item, index) => (
                    <div 
                        key={index} 
