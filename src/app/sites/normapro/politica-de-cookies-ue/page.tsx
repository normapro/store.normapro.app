...
const PoliticaCookies = () => {
    return (
        <section className="max-w-6xl mx-auto py-12 px-6 md:px-12 text-[#010d3d]">
            <h1 className="text-3xl md:text-4xl font-semibold mb-4">Política de cookies (UE)</h1>
            ...
            <div className="space-y-8">
                {/* 1. Introducción */}
                <h2 className="text-2xl font-black">1. Introducción</h2>
                <p>
                ...
                <h2 className="text-2xl font-black">2. ¿Qué son las cookies?</h2>
                <p>
                ...
                <h2 className="text-2xl font-black">3. ¿Qué son los scripts?</h2>
                <p>
                ...
                <h2 className="text-2xl font-black">4. ¿Qué es una baliza web?</h2>
                <p>
                ...
                {/* 6. Cookies usadas */}
                <h2 className="text-2xl font-black">6. Cookies usadas</h2>
                <Cookies />

                {/* 7. Consentimiento */}
                <h2 className="text-2xl font-black">7. Consentimiento</h2>
                <p>
                ...
                <h2 className="text-2xl font-black">8. Activación/desactivación y borrado de cookies</h2>
                <p>
                ...
                <h2 className="text-2xl font-black">9. Tus derechos con respecto a los datos personales</h2>
                <p>
                ...
                <h2 className="text-2xl font-black">10. Datos de contacto</h2>
                <p>
