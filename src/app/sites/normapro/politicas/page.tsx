                    ...
                    content: (
                        <>
                            ...
                            <ul className="mt-4 list-disc space-y-2 pl-6">
                                <li>Implementar un sistema de gestión documentado y medible, garantizando la mejora continua de los procesos, procedimientos, productos y servicios, con el fin de prestar servicios que satisfagan los requisitos de los clientes.</li>
                                <li>Asignar las funciones y responsabilidades necesarias para el correcto funcionamiento del SIG, en base a los procedimientos correspondientes para su designación.</li>
                                <li>Desarrollar la gestión del personal, programas de formación y concienciación sobre el personal que garanticen el nivel de capacitación, competencia e implicaciones en el SIG adecuadas a sus funciones.</li>
                                <li>Promover la implantación de las medidas necesarias para garantizar el cumplimiento de la legislación vigente en materia de seguridad de la información.</li>
                                <li>Promover la implantación de los niveles de seguridad apropiados que permitan una gestión adecuada de los incidentes de seguridad que pudiesen afectar a los activos de información de la Organización.</li>
                                <li>INICIE depende de sus Sistemas de Información para alcanzar sus objetivos y satisfacer las necesidades y expectativas de sus clientes. Por este motivo, los sistemas de información de INICIE deben ser administrados con diligencia, tomando las medidas adecuadas para protegerlos frente a daños accidentales o deliberados que puedan afectar a la disponibilidad, integridad o confidencialidad de la información tratada o los servicios prestados.</li>
                            </ul>
